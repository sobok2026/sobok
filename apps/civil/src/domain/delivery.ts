...
export const CivilDeliveryItemWorkSchema = z.strictObject({
  artifactId: z.uuid(),
...
export const CivilDeliveryGenerationWorkSchema = z.strictObject({
  packageId: z.uuid(),
...
export const CivilDeliveryManifestSchema = z.strictObject({
...
export const CivilDeliveryGenerationOutputSchema = z.strictObject({
  byteSize: z.number().int().min(1),
  sha256: z.string().regex(/^[0-9a-f]{64}$/),
