/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=/dev/null --include-runtime=false --strict-vars=false --env-interface=DatabaseBindings worker-configuration.generated.d.ts` (hash: 14cef10b40d409aec179b9d861fba930)
interface __BaseEnv_DatabaseBindings {
	CIVIL_FILES: R2Bucket;
	HYPERDRIVE_FRESH: Hyperdrive;
	HYPERDRIVE_CACHED: Hyperdrive;
	ACCOUNTS_EMAIL_QUEUE: Queue;
	CIVIL_CALCULATION_QUEUE: Queue;
	CIVIL_ARTIFACT_QUEUE: Queue;
	CIVIL_DELIVERY_QUEUE: Queue;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ACCOUNTS_PUBLIC_ORIGIN" | "ACCOUNTS_ALLOWED_HOSTNAMES" | "ACCOUNTS_FIRST_PARTY_CLIENT_IDS" | "ACCOUNTS_EMAIL_FROM" | "ACCOUNTS_EMAIL_REPLY_TO" | "ACCOUNTS_GOOGLE_CLIENT_ID" | "ACCOUNTS_KAKAO_CLIENT_ID" | "ACCOUNTS_BBATON_CLIENT_ID" | "CIVIL_PUBLIC_ORIGIN" | "CIVIL_ACCOUNTS_ISSUER" | "CIVIL_OIDC_CLIENT_ID" | "CIVIL_STORAGE_CAP_BYTES" | "STELLA_ALLOWED_HOSTNAMES" | "STELLA_PUBLIC_ORIGIN" | "STELLA_GUARDIAN_ASSET_ORIGIN" | "STELLA_ACCOUNTS_ISSUER" | "STELLA_OIDC_CLIENT_ID" | "STELLA_EMAIL_FROM" | "STELLA_EMAIL_REPLY_TO" | "DEEPTYPE_PAY_PROFILE" | "DEEPTYPE_PUBLIC_ORIGIN" | "DEEPTYPE_EMAIL_FROM" | "DEEPTYPE_EMAIL_REPLY_TO" | "DEEPTYPE_REPORT_MODEL" | "DEEPTYPE_GA4_MEASUREMENT_ID">> {}
}
