...
export const LEGAL = {
  [Locale.KO]: {
    ...
    privacy: {
      title: '개인정보처리방침',
      description: '로빈리뷰가 vibe(결타레·딥타입) 서비스에서 이용자의 정보를 어떻게 다루는지 안내합니다.',
      ...
      sections: [
        {
          ...
          body: [
            ...
            '딥타입 무료 결과는 브라우저에서 계산됩니다. 이용자가 유료 감정서 결제를 시작하면 결과 코드와 답변이 구매·감정서 제공을 위해 서버로 전송됩니다. 구매로 이어지지 않거나 결제가 실패·대기 상태로 끝난 데이터는 생성 또는 결제 시도 후 30일에 파기합니다.',
          ],
        },
        {
    ...
    terms: {
      title: '이용약관',
      description: '로빈리뷰가 운영하는 vibe(결타레·딥타입) 서비스 이용에 적용되는 약관입니다.',
      effectiveDate: '2026년 7월 22일',
      updatedDate: '2026년 7월 22일',
      version: '1.0',
      sections: [
        {
          heading: '서비스 소개',
          body: [
            '결타레는 커플 케미를 가볍게 확인하는 무료 테스트와 자기 이해를 돕는 유료 감정서(딥타입 정밀 감정서)를 제공하는 서비스이며 로빈리뷰가 운영합니다.',
          ],
        },
        {
          heading: '용어와 계약의 성립',
          body: [
            '서비스는 vibe.sobok.cc에서 제공되는 무료 테스트와 딥타입 기능을, 감정서는 결제 후 생성되는 디지털 리포트를 뜻합니다. 이용자는 결제 화면에서 상품·가격·제공 기간·필수 동의를 확인하고 카드 결제를 완료하면 감정서 이용 계약을 맺습니다.',
        ...
        },
        {
          heading: '유료 서비스와 결제',
          body: [
            '딥타입 정밀 감정서는 5,900원(VAT 포함)의 유료 디지털 콘텐츠입니다. 현재 결제수단은 PortOne을 통해 연결되는 Toss Payments 카드 결제입니다. 승인 전 화면에 표시된 최종 금액을 확인해야 합니다.',
    ...
    refund: {
      title: '청약철회·환불 정책',
      description: '딥타입 정밀 감정서의 청약철회와 환불에 관한 사항을 안내합니다.',
      effectiveDate: '2026년 7월 22일',
      updatedDate: '2026년 7월 22일',
      version: '1.0',
      sections: [
        ...
        },
        {
          ...
          body: [
            '딥타입 정밀 감정서는 디지털 콘텐츠입니다. 전자상거래법 제17조 제2항에 따라 콘텐츠의 제공이 개시되면 청약철회가 제한될 수 있습니다.',
