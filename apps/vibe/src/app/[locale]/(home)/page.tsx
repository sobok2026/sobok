  ...
  return (
    <main className="flex flex-1 flex-col bg-page-bg px-safe py-14 text-page-ink sm:py-20">
      <div className="mx-auto w-full max-w-3xl px-4 sm:px-6">
        <p className="font-bold text-page-accent text-sm">{SITE_NAME[locale]}</p>
        ...
        <div className="mt-10 grid gap-5">
          ...
          >
            ...
            <p className="mt-3 text-page-ink/66 leading-7">{t('gyeolCard.description')}</p>
          ...
          >
            ...
            <p className="mt-3 text-page-ink/66 leading-7">{t('typeCard.description')}</p>
            <span className="mt-6 inline-flex min-h-11 items-center justify-center rounded-full bg-page-ink px-5 font-bold text-sm text-white transition-colors group-hover:bg-page-ink/92">
              {t('typeCard.cta')}
            </span>
          </Link>
          ...
          >
            ...
            <p className="mt-3 text-page-ink/66 leading-7">{t('deepTypeCard.description')}</p>
            <span className="mt-6 inline-flex min-h-11 items-center justify-center rounded-full bg-page-ink px-5 font-bold text-sm text-white transition-colors group-hover:bg-page-ink/92">
              {t('deepTypeCard.cta')}
            </span>
          </Link>
