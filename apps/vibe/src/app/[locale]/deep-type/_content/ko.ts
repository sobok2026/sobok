...
export const deepTypeContent = createDeepTypeContent({
  ...
  ui: {
    ...
    declareNotice: '모르겠어요를 고르면 정밀 리포트에서 그 비교를 다루는 대목이 빠져요. 나머지는 그대로 나와요.',
    declareTitle: '알고 있는 네 글자가 있나요?',
    declareUnknownLabel: '모르겠어요',
    landingCta: '무료로 시작하기',
    landingNote: `무료 · 약 ${FREE_EFFORT.minMinutes}~${FREE_EFFORT.maxMinutes}분 · 완료 즉시 내 세계관 직업 확인 · 정밀 결과 ${PRICE_KO} · 한 번 결제`,
