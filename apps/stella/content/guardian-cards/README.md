...
| `production-art-batch-015-review-ko.json`    | `editorial_review_ready` | 열다섯 번째 production 배치 신규 12개 원고·비지시적 곁 구도 편집 승인 대기  |
...
구도는 사람의 최종 편집 승인 대기 상태이며, 승인 전에는 imagegen·WebP 변환·R2 업로드를 진행하지
않는다.
