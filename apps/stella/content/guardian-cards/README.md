...
| `production-art-batch-035-review-ko.json`    | `visual_review_ready`    | 서른다섯 번째 production 배치 신규 PNG 12개 교차 QA 완료·사람 시각 승인 대기  |
...
현재 12개 모두 사람의 최종 시각 승인 대기 상태이며 WebP 최적화와 R2·staging·production 배포는 이후
배치와 함께 일괄 진행한다.
