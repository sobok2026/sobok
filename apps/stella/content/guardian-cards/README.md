...
| `production-art-batch-038-review-ko.json`    | `visual_review_ready`    | 서른여덟 번째 production 배치 파일럿 1개·신규 PNG 11개 교차 QA 완료·사람 시각 승인 대기 |
...
`apps/stella/private/guardian-art-production/love-boundary-and-space-nebula`에 보관한다. 현재 사람의 최종
시각 승인을 기다리며 WebP 최적화와 R2·staging·production 배포는 이후 배치와 함께 일괄 진행한다.
