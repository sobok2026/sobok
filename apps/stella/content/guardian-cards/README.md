...
| `production-art-batch-007-review-ko.json`    | `editorial_review_complete` | 일곱 번째 production 배치 파일럿 1개·신규 원화 11개 편집 승인 완료  |
...
승인을 마쳤으며, 현재 승인된 해시와 구도로 원화 후보를 제작할 수 있다. 생성 후보도 사람의 최종 시각
승인 전에는 WebP 변환·R2 업로드를 진행하지 않는다.
