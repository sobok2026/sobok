...
| `production-art-batch-030-review-ko.json`    | `editorial_review_complete` | 서른 번째 production 배치 신규 12개 원고·구도 사람의 편집 승인 완료           |
...
imagegen은 고정된 승인 해시만 입력으로 사용한다. 현재 신규 12개 이미지는 생성 미착수 상태다.
