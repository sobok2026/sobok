...
| `production-art-batch-017-review-ko.json`    | `visual_review_ready`    | 열일곱 번째 production 배치 파일럿 1개·신규 PNG 11개 보조 시각 QA·최종 시각 승인 대기 |
...
제외한 신규 11개는 사람의 최종 시각 승인을 기다린다. 따라서 누적 승인 WebP 202개와 잔여 원화 854개
수치는 아직 바뀌지 않는다.
