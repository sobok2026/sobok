...
| `production-art-batch-023-review-ko.json`    | `editorial_review_complete` | 스물세 번째 production 배치 신규 12개 Eclipse 구도 편집 승인 완료             |
...
전까지 누적 승인 WebP 273개와 잔여 783개 산식은 바뀌지 않는다.
