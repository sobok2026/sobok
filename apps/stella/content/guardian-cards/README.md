...
| `production-art-batch-020-review-ko.json`    | `visual_review_ready`    | 스무 번째 production 배치 신규 PNG 12개 보조 시각 QA·최종 시각 승인 대기      |
...
선택본과 비교 시트는 공개 Git에 포함하지 않는
`apps/stella/private/guardian-art-production/love-first-signal-stella`에 보관한다. 원화의 사람 최종 시각 승인
전까지 누적 승인 WebP 237개와 잔여 819개 산식은 바뀌지 않는다.
