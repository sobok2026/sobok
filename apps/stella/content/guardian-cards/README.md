...
| `production-art-batch-014-review-ko.json`    | `editorial_review_complete` | 열네 번째 production 배치 신규 12개 원고·작은 성장 행동 구도 최종 편집 승인 완료 |
...
꿈문 열기처럼 서로 다른 중간·넓은 행동 구도를 사용한다. 현재 12개 원고 해시와 구도는 2026-08-16
