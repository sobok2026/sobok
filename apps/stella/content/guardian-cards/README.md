...
| `production-art-batch-022-review-ko.json`    | `visual_review_ready`    | 스물두 번째 production 배치 신규 PNG 12개 최종 시각 승인 대기                 |
...
원화의 사람 시각 승인 전까지 누적 승인 WebP 261개와 잔여 795개 산식은 바뀌지 않는다.
