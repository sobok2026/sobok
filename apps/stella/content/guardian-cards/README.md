...
| `production-art-batch-004-review-ko.json`    | `editorial_review_complete` | 네 번째 production 배치 12개 원고·별자리 여운 구도 사람 승인 완료   |
...
단순 곡선만 사용한다. 12개 원고 해시와 구도의 사람 편집 승인을 2026-08-15에 마쳤으며, 승인한 입력만
사용해 PNG 후보를 생성한다.
