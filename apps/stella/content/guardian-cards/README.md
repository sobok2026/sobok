...
| `production-art-batch-031-review-ko.json`    | `visual_review_ready`    | 서른한 번째 production 배치 신규 PNG 12개 시각 검토 준비, 사람 승인 대기      |
...
12개 모두 `generated_candidate`이며 사람의 최종 시각 승인 전에는 WebP/R2 반영을 허용하지 않는다.
