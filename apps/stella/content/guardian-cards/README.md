...
| `production-art-batch-016-review-ko.json`    | `visual_review_ready`    | 열여섯 번째 production 배치 신규 PNG 12개 보조 시각 QA·사람 시각 승인 대기  |
...
12개는 사람의 최종 시각 승인 대기 상태이며 승인 전에는 WebP 변환·R2 업로드를 진행하지 않는다.
