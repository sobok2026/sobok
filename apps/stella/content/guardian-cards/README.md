...
| `production-art-batch-013-review-ko.json`    | `editorial_review_ready` | 열세 번째 production 배치 신규 12개 원고·작은 성장 근접 구도 편집 승인 대기 |
...
꿈문과 중심 별그릇처럼 서로 다른 가까운 프레임을 사용한다. 현재 12개 원고 해시와 구도는 사람의 최종
