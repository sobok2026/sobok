...
| `production-art-batch-019-review-ko.json`    | `visual_review_ready`    | 열아홉 번째 production 배치 신규 PNG 12개 보조 시각 QA·최종 시각 승인 대기    |
...
원화의 사람 최종 시각 승인 전까지 누적 승인 225개와 잔여 831개 산식은 바뀌지 않는다.
