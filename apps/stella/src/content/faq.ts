...
export const FAQ = {
  ko: {
    ...
    today: [
      ...
      {
        q: '오늘의 흐름은 매일 바뀌나요?',
        a: '네, 행성과 달이 매일 움직여서 오늘의 무대와 행운 음식·색상, 오늘의 수호령 카드도 현지 자정마다 새로 떠요. 같은 브라우저에서는 같은 날짜와 차트로 언제 다시 보아도 같은 결과를 확인할 수 있어요.',
      },
      {
        q: '수호령 카드는 어떻게 정해지나요?',
        a: '나를 돌아보는 카드·사랑 카드·일 카드·선택 카드를 나흘에 걸쳐 한 번씩 만나요. 순서는 사람마다 달라요. 출생 차트가 있으면 내 태양 별자리와 그날의 별자리 정보를 함께 참고하고, 없으면 그날 달이 머무는 별자리를 기준으로 골라요. 한번 정해진 카드는 바뀌지 않고, 다시 뽑을 수는 없어요.',
      },
      {
        q: '사랑 카드의 Orbit·Nebula·Eclipse·Stella는 무엇인가요?',
        a: '사랑 카드의 네 가지 그림 종류예요. Orbit 55%, Nebula 30%, Eclipse 12%, Stella 3%의 비율로 정해지며, 그림 종류에 따라 해석의 분량이나 가치가 달라지지는 않아요. 추가로 결제해서 다시 뽑을 수는 없고, 미리 본 내일 카드는 다음 날에도 그대로 볼 수 있어요.',
      },
      {
        q: '7일 선공개권은 자동으로 갱신되나요?',
        a: '아니요. 한 번 결제하면 구매 시점부터 정확히 168시간 동안 내일의 수호령 카드를 하루 먼저 볼 수 있고 자동으로 갱신되지 않아요. 자정이 지나 오늘 카드가 되면 누구나 무료로 볼 수 있어요.',
      },
    ],
    love: [
      {
