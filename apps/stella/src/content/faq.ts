...
export const FAQ = {
  ko: {
    ...
    today: [
      ...
      {
        q: '수호령 카드는 어떻게 정해지나요?',
        a: '나를 보는 카드·사랑 카드·일 카드·선택 카드가 사용자마다 다른 순서로 4일 동안 한 번씩 나타나요. 출생 차트가 있으면 태양 별자리와 그날의 흐름을 조합하고, 없으면 그날 달이 머무는 별자리를 기준으로 한 장을 골라요. 한번 공개된 카드는 바뀌거나 재추첨되지 않아요.',
      },
      {
        q: '사랑 카드의 Orbit·Nebula·Eclipse·Stella는 무엇인가요?',
        a: '같은 사랑의 흐름을 서로 다른 그림 결로 보여 주는 네 가지 표현이에요. 고정 비율은 Orbit 55%, Nebula 30%, Eclipse 12%, Stella 3%이며 해석 분량이나 가치에는 차이가 없어요. 별도 구매로 다시 뽑을 수 없고, 내일 미리 본 카드는 다음 날에도 그대로 유지돼요.',
      },
      {
