      ...
      sections: [
        {
          ...
          body: [
            '별무리는 생년월일과 태어난 시각 그리고 출생지를 바탕으로 서양 점성술의 탄생 차트(네이탈 차트)와 운세를 풀어 주는 웹 도구입니다. 회원가입 없이 누구나 바로 이용할 수 있으며 태양 별자리 하나만 보는 일반 운세와 달리 태어난 순간의 하늘 전체를 계산해 더 입체적인 나를 보여 줍니다.',
          ],
        },
        {
          heading: '탄생 차트란 무엇인가요',
          body: [
            '탄생 차트는 태어난 순간 하늘에 놓인 태양과 달 그리고 행성의 위치를 그린 지도입니다. 흔히 아는 "무슨 자리"는 그중 태양 별자리 하나이며 별무리는 여기에 달 별자리와 상승 별자리 그리고 열두 하우스까지 함께 읽어 나의 성향과 삶의 영역을 더 자세히 그려 줍니다.',
          ],
        },
        {
          heading: '무엇을 할 수 있나요',
