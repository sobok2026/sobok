...
export const FAQ = {
  [Locale.KO]: {
    ...
    constellation: [
      ...
      {
        q: '태양 별자리랑 탄생 차트는 뭐가 다른가요?',
        a: '흔히 아는 "무슨 자리"는 태양 별자리 하나예요. 탄생 차트는 태양에 더해 달·수성·금성·화성처럼 여러 행성이 어느 자리와 하우스에 놓였는지까지 담아 성향을 훨씬 자세히 그려 줘요.',
      },
      {
        q: '무료인가요? 입력한 출생 정보는 안전한가요?',
        a: '별무리의 탄생 차트는 회원가입 없이 무료로 볼 수 있어요. 생년월일과 시각은 브라우저 안에서만 계산되고 서버로 전송되지 않아서 안심하고 사용하셔도 돼요.',
      },
    ],
    today: [
      {
        q: '오늘의 별자리 운세는 어떻게 계산되나요?',
        a: '오늘 하늘을 지나는 행성의 위치를 내 탄생 차트에 겹쳐 흐름을 읽어요. 그래서 같은 날이라도 사람마다 오늘의 결이 다르게 나와요.',
      },
      {
      ...
      {
        q: '오늘의 흐름은 매일 바뀌나요?',
        a: '네 행성과 달이 매일 움직여서 오늘의 무대와 추천도 날마다 새로 떠요. 하루 한 번 들러 그날의 하늘을 확인해 보세요.',
      },
    ],
    love: [
      {
    ...
    today: [
      {
        ...
        a: "We overlay the planets moving through today's sky onto your birth chart. That is why the same day reads differently for each person.",
      },
      {
      ...
      },
      {
        ...
        a: 'Yes — the planets and Moon move daily, so your stage and suggestions are new each day. Drop by once a day to check the sky.',
      },
    ],
    love: [
      {
  ...
  [Locale.JA]: {
    ...
    today: [
      {
        q: '今日の星座占いはどう計算されますか？',
        a: '今日の空を通る惑星の位置を、あなたの出生図に重ねて流れを読みます。だから同じ日でも人によって今日の質感が変わります。',
      },
      {
      ...
      {
        q: '今日の流れは毎日変わりますか？',
        a: 'はい。惑星と月は毎日動くので、今日の舞台やおすすめも日ごとに新しく現れます。一日一度立ち寄って空を確かめてみてください。',
      },
    ],
    love: [
      {
  ...
  [Locale.ZH]: {
    ...
    today: [
      {
        q: '今天的星座运势是怎么计算的？',
        a: '我们把今天经过天空的行星位置叠加到你的出生星盘上来解读流势。所以同一天，每个人的今日质感都不一样。',
      },
      {
        q: '水星逆行之类的行星逆行是什么意思？',
      ...
      {
        q: '今天的流势每天都会变吗？',
        a: '会的，行星和月亮每天都在移动，今天的舞台和建议也每天更新。每天来看一次当天的天空吧。',
      },
    ],
    love: [
      {
