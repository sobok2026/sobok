...
export default function PersonaArt({ className, sign }: { className?: string; sign: SignId }) {
  ...
  return (
    <svg aria-hidden className={className} viewBox="0 0 120 120">
      ...
      <circle cx="60" cy="60" fill="url(#persona-halo)" r="56" />

      {/* Two orbits meeting — you and the partner the descendant describes. */}
      <circle cx="47" cy="60" fill="none" r="40" stroke={color} strokeOpacity="0.3" strokeWidth="0.8" />
      <circle cx="73" cy="60" fill="none" r="40" stroke="#fff" strokeOpacity="0.16" strokeWidth="0.8" />
      ...
      {/* The descendant sign's asterism, scaled into the frame. */}
