...
- production 원화: 12별자리 파일럿과 production 배치 20개의 신규 237개 최종 시각 승인 완료, 누적 최적화
  WebP 249개와 R2 배포 매니페스트 고정
...
- 스물한 번째 production 배치: `love.careful-approach.orbit` 신규 12개 정본 원고 해시와 상대의 몸·손·
  ...
  다른 카메라 높이·조절 소품·응답 여백 고정, 신규 PNG 후보·마스터/80px·이전 스무 배치 비교 보조
  시각 QA 완료, 사람의 최종 시각 승인 대기
