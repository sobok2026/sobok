...
- production 원화: 12별자리 파일럿과 production 배치 4개의 신규 47개 최종 시각 승인 완료, 누적 최적화
  WebP 59개와 R2 배포 매니페스트 고정
...
- 다섯 번째 production 배치: `self.hidden-need.close-emotion` 12개 원고 해시와 앞선 네 배치 비반복
  얼굴·손끝·중심 소품 근접 구도, PNG 후보·마스터/80px 보조 시각 QA 완료·사람의 최종 시각 승인 대기
