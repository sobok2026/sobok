...
- production 원화: 12별자리 파일럿과 production 배치 16개의 신규 190개 최종 시각 승인 완료, 누적 최적화
  WebP 202개와 R2 배포 매니페스트 고정
...
- 열일곱 번째 production 배치: `love.first-signal.orbit` 승인 양자리 파일럿 1개 보존, 신규 11개 원고
  ...
  카메라·소품·빈자리 구도, 신규 PNG 후보·마스터/80px·이전 열여섯 배치 비교 보조 시각 QA 완료·
  사람의 최종 시각 승인 대기
