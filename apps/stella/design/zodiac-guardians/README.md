...
- production 원화: 12별자리 파일럿과 production 배치 17개의 신규 201개 최종 시각 승인 완료, 누적 최적화
  WebP 213개와 R2 배포 매니페스트 고정
...
- 열여덟 번째 production 배치: `love.first-signal.nebula` 신규 12개 원고 해시와 이미 건넨 첫 신호를
  ...
  카메라·날씨 경계·보호 실루엣, 신규 PNG 후보·마스터/80px·이전 열일곱 배치 비교 보조 시각 QA 완료·
  사람의 최종 시각 승인 대기
