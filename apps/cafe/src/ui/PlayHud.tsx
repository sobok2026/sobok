...
import { INGREDIENTS, RECIPES, recipeLabel, STATIONS } from '../game/catalog'
import { craftStations } from '../game/crafting'
import { CUP_NAMES, cleanCupCount, cupCount, cupKindFor, SERVICE_NAMES } from '../game/cups'
import { nextStep } from '../game/progress'
import { SUPPLIES } from '../game/supplies'
import { WASH_NAMES, washDestination } from '../game/washing'
