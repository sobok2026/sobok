...
import { useWriterLock } from './use-writer-lock'
import { actionSound, tickSound, workLoop } from './work-sounds'
...
export type CafeSession = ReturnType<typeof useCafeSession>
