import type { IngredientId, RecipeId, StationId } from './catalog'
import type { CleaningStation } from './cleaning'
import type { DisposableCupKind, ServiceMode } from './cups'
import type { PreparationId } from './preparation'
import type { SupplyId } from './supplies'
import type { WashItem } from './washing'
