import { INGREDIENTS, type IngredientId, ingredientIds, staffStartPosition } from './catalog'
import { CUP_SUPPLY, emptyCupCounts, REUSABLE_CUPS_PER_KIND } from './cups'
import { createCustomer } from './customer'
import { newBatch } from './inventory'
import { emptyTotals, type GameState, uid } from './state'
import { SUPPLY_CAPACITY, SUPPLY_PACK } from './supplies'
