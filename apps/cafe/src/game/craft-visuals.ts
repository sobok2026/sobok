...
import { type CraftTool, cupSpot, operationFor } from './crafting'
import { CUP_DIMENSIONS } from './cup-visual'
import { createDrinkVisual } from './drink-visual'
import type { GameState } from './state'
import { addVesselLabel } from './vessel-label'
import { workBox as block, workCylinder as cylinder, workMaterial as standard } from './work-geometry'
