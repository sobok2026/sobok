import { type CupSurfaceId, orderSequence, RECIPES, STATIONS } from './catalog'
import { cupSurface } from './cleaning'
import { type ReusableCupKind, reusableCupFor } from './cups'
import {
  CUSTOMER_SECONDS,
  createCustomer,
  customerLeave,
