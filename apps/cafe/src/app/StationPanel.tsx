  ...
  return (
    <div className="pointer-events-none absolute inset-0 z-8 bg-[linear-gradient(90deg,#263c281f,transparent_70%)]">
      <section
        ...
        [scrollbar-color:#c6cdb9_transparent] overflow-auto rounded-2xl border border-white/60 bg-surface
        p-6 shadow-panel compact:top-20 compact:p-5 max-wide:left-5 max-tablet:top-21 max-tablet:bottom-4
      ...
      >
        <div className="flex items-center justify-between">
          ...
          <button
            type="button"
            className={`
              pointer-events-auto grid size-10 shrink-0 place-items-center rounded-full border-0 border-line
              bg-transparent text-[1.625rem] text-[#8e9881]
            `}
            onClick={() => closePanel()}
            aria-label="작업대 닫기"
          >
